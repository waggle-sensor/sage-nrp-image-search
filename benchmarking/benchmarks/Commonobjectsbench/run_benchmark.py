...
def load_data(
    ...
    """Load CommonObjectsBench dataset into the vector database."""
    try:
        ...
        logging.info(
            f"Successfully loaded {config.commonobjectsbench_dataset} into {config.vector_db} collection '{config._collection_name}'"
        )
