...
def load_data(
    ...
    """Load Sagebench dataset into the vector database."""
    try:
        ...
        logging.info(
            f"Successfully loaded {config.sagebench_dataset} into {config.vector_db} collection '{config._collection_name}'"
        )
