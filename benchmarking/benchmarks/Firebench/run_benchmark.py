...
def load_data(
    ...
    """Load FireBench dataset into the vector database."""
    try:
        ...
        logging.info(
            f"Successfully loaded {config.firebench_dataset} into {config.vector_db} collection '{config._collection_name}'"
        )
