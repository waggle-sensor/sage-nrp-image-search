...
Per-user concurrency and context limits apply to gateway captioning — see [Configuration → NRP fair use](configuration.md#nrp-fair-use-when-llm_run_modenrp) (monitoring links included) and the [NRP fair use policy](https://nrp.ai/documentation/userdocs/ai/llm-managed/fair-use/).
